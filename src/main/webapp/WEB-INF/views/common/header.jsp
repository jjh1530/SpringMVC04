...
<c:set var="mvo" value="${SPRING_SECURITY_CONTEXT.authentication.principal}"/>   <!-- 아이디 -->
<c:set var="auth" value="${SPRING_SECURITY_CONTEXT.authentication.authorities}"/>  <!-- 권한 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	            ...
	            <li><a href="javascript:logout()"><span class="glyphicon glyphicon-log-out"></span>로그아웃</a></li>
				    ...
				    <label>환영합니다.</label>
				  	...
				  	<c:if test="${empty mvo.member.memProfile}">
				  		<li style="color:white;"><img src="${contextPath }/resources/images/person.png"  class="img-circle"style="width:50px; height:50px;"/>
				  	</c:if>	
				  	<c:if test="${!empty mvo.member.memProfile}">
				  		<li style="color:white;"><img src="${contextPath }/resources/upload/${mvo.member.memProfile}"  class="img-circle"style="width:50px; height:50px;"/>
				  	</c:if>	
